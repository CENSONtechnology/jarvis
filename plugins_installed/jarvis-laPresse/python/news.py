...
PLUGIN_PATH = os.getcwd() + "/plugins_installed/jarvis-laPresse"
...
def news() :
    ...
    if rubrique != "non reconnu" :
        reply = "Les actualités de La Presse concernant le Québec sont :\n\n"
        
        res = requests.get("http://www.lapresse.ca/rss/178.xml")
